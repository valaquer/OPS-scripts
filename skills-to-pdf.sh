...
OUTPUT_BASE="/Users/deepak-macmini/honeybloom/print-skills"
...
for name in "${TEAMMATES[@]}"; do
    skills_dir="/Users/deepak-macmini/honeybloom/${name}/.claude/skills"
...
echo ""
echo "EXTRA:"
extra_src="/Users/deepak-macmini/honeybloom/lea/ai-pm-tools-landscape-2026.md"
